...
class TestRegularExp: XCTestCase {
    ...
    func testLineStartReg() throws {
        ...
        XCTAssertNotNil("一二零百十、测试，123".range(of: lineStartRe, options: .regularExpression))
        XCTAssertNotNil("一千、测试，123".range(of: lineStartRe, options: .regularExpression))
        XCTAssertNotNil("第一万条 测试，123".range(of: lineStartRe, options: .regularExpression))
